  ...
  return (
    <div className='bg-[#1c1c1c] p-5 rounded mt-5'>
        ...
        {AuthData.employees.map(function(elem,idx){
            ...
            <h2 className='text-lg font-medium text-red-600 w-1/5'>{elem.firstname}</h2>
            ...
            <h5 className='text-lg font-medium w-1/5 text-white'>{elem.taskCount.completedTask}</h5>
